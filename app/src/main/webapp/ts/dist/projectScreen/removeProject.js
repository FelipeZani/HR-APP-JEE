...
async function removeProject(projectId) {
    ...
    const removeProjectDialog = document.getElementById("removeproject-dialog");
...
const removeProjectSubmitButton = document.getElementById("removeproject-submitButton");
